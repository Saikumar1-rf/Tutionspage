    ...
    <div>
      <nav className="bg-blue-600 p-4 relative w-full">
        <div className="flex items-center justify-between">
          ...
          <Link to='/tutorpage'><li className="cursor-pointer hover:text-gray-200 px-4">Admin</li></Link>
          {/* <Link to='/saikumar'><li className="cursor-pointer hover:text-gray-200 px-4">Saikumar</li></Link> */}
          {/* <Link to='/benifits'><li className="cursor-pointer hover:text-gray-200 px-4">Benifits</li></Link> */}
